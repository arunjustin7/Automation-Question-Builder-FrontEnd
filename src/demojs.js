...
// import { FileText, Sun, Moon, Loader, Download, Star, MessageSquare, Shield, BarChart as BarchartIcon } from 'lucide-react';
// import { useReactToPrint } from 'react-to-print';
// import { ToastContainer, toast } from 'react-toastify';
// import 'react-toastify/dist/ReactToastify.css';
// import io from 'socket.io-client';
// import { LineChart, BarChart, Tooltip, XAxis, YAxis, CartesianGrid, Line, Bar } from 'recharts';
...
//                 <h3 className="text-lg font-semibold mb-4 text-purple-600 dark:text-purple-300">
//                     Question Generation Time
//                 </h3>
//                 <LineChart width={400} height={300} data={analytics.timeSeriesData}>
//                     <CartesianGrid strokeDasharray="3 3" />
//                     <XAxis dataKey="timestamp" />
//                     <YAxis />
//                     <Tooltip />
//                     <Line type="monotone" dataKey="generationTime" stroke="#8884d8" />
//                 </LineChart>
//             </div>
...
//                     Questions by Type
//                 </h3>
//                 <BarChart width={400} height={300} data={analytics.questionsByType}>
//                     <CartesianGrid strokeDasharray="3 3" />
//                     <XAxis dataKey="type" />
//                     <YAxis />
//                     <Tooltip />
...
//                         <p className="text-gray-800 dark:text-gray-200">{item.question}</p>
//                         <div className="flex space-x-4 mt-2 text-sm text-gray-600 dark:text-gray-400">
//                             <span>Type: {item.type}</span>
//                             <span>Difficulty: {item.difficulty}</span>
//                             <span>Generated: {new Date(item.timestamp).toLocaleDateString()}</span>
//                         </div>
//                     </div>
//                 ))}
//             </div>
...
//         try {
//             const response = await axios.get(`${API_ENDPOINT}/analytics`, { withCredentials: true });
...
//         try {
//             const response = await axios.post(`${API_ENDPOINT}/export-questions`, {
...
//             <div className="bg-gradient-to-br from-purple-900 to-indigo-200 dark: dark:to-indigo-900 min-h-screen transition-colors duration-500">
...
//                                 <h2 className="text-xl font-semibold mb-2 text-purple-600 dark:text-purple-300">Your Stats</h2>
...
//                                     >
//                                         <BarchartIcon className="w-8 h-8 text-purple-600 dark:text-purple-300 mb-2" />
...
//                         )}
//                         {isAuthenticated && questionHistory.length > 0 && (
